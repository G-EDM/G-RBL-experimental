...
enum setget_param_enum {
    ...
    PARAM_ID_DRAW_LINEAR_DEPRECATED,
    PARAM_ID_EDGE_THRESH,
    PARAM_ID_I2S_SAMPLES_DEPRECTAED,
    PARAM_ID_I2S_RATE,
    ...
    PARAM_ID_BEST_OF,
    PARAM_ID_USEHWTIMTER_DEPRECATED,
    PARAM_ID_FAVG_SIZE,
...
#define TT_PARAM_ID_POFF_AFTER            "Turn PWM off after\rNumber of voltage (vFd) short circuits\rin a row to turn PWM off shortly"
